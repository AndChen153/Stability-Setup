...
def resetPnO():
    global arr
    arr = np.empty([5, 33], dtype="object")
    ...
    arr[4] = ["Pixel 0 VSet","Pixel 0 V","Pixel 0 mA", "Pixel 0 PCE", "Pixel 1 VSet","Pixel 1 V","Pixel 1 mA", "Pixel 1 PCE", "Pixel 2 VSet","Pixel 2 V","Pixel  mA", "Pixel 2 PCE", "Pixel 3 VSet","Pixel 3 V","Pixel 3 mA", "Pixel 3 PCE", "Pixel 4 VSet","Pixel 4 V","Pixel 4 mA", "Pixel 4 PCE", "Pixel 5 VSet","Pixel 5 V","Pixel 5 mA", "Pixel 5 PCE", "Pixel 6 VSet","Pixel 6 V","Pixel 6 mA", "Pixel 6 PCE", "Pixel 7 VSet","Pixel 7 V","Pixel 7 mA", "Pixel 7 PCE",  "Time"]
...
if __name__ == '__main__':
    ...
    # while line != "Done!":
    while not done:
        fileName = "./data/" + mode + "_" + today + ".csv"
        if ser.in_waiting > 0:
            if run:
                if mode == "scan":
                    resetScanArr()
